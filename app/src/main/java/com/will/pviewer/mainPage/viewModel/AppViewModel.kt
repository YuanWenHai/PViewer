...
class AppViewModel(val apiService: ApiService,repository: ArticleWithPicturesRepository): ViewModel() {
    ...
    val currentDisplayingArticle = MutableLiveData<ArticleWithPictures>()
    val currentDisPlayingPictureIndex = MutableLiveData(0)
